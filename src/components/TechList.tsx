...
export const TechList = memo<TechListProps>(
  ({ technologies, scrollProgress, introText }) => {
...
const TechItem = memo<TechItemProps>(({ name, index, scrollProgress }) => {
  // ✅ Správne: Hooks volané na top-level
  const baseStart = 0.5;
  ...
  return (
    ...
    >
      ...
      <span className="relative z-10 font-mono text-sm text-black  dark:text-white transition-colors duration-300">
        {name}
      </span>
