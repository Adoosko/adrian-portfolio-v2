...
const ProfileImage = memo(
  React.lazy(() =>
    import("../ProfileImage").then((m) => ({ default: m.ProfileImage }))
  )
);
const ScrollTextReveal = memo(
  React.lazy(() =>
    import("../ScrollRevealText").then((m) => ({ default: m.ScrollTextReveal }))
  )
);
const SectionHeader = memo(
  React.lazy(() =>
    import("../SectionHeader").then((m) => ({ default: m.SectionHeader }))
  )
);
const TechList = memo(
...
const About: React.FC<AboutProps> = ({ data }) => {
  ...
  const headerProps = useMemo(
    () => ({ scrollProgress: scrollYProgress, title: data.title }),
